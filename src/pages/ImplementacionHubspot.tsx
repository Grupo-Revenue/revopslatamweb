...
export default function ImplementacionHubspot() {
  ...
  usePageMeta({ ...PAGE_SEO["/implementacion-hubspot"], path: "/implementacion-hubspot" });
        ...
        <div className="relative z-10 w-full max-w-[1100px] mx-auto px-6 pt-32 pb-20 grid lg:grid-cols-[55%_45%] gap-12 items-center">
          <div>
            ...
            <motion.div {...fadeUp(0.2)} className="flex flex-wrap items-center gap-4">
              <DynamicCTA styleKey={hm.cta_style_key as string} onClick={() => { if (hm.cta1_opens_lead_form) { openLeadForm("implementacion-hero"); } else if (hero?.cta_url) { window.open(hero.cta_url, "_blank"); } }} className="transition-all duration-200">{h.cta}</DynamicCTA>
