...
const HubspotPartnerChile = () => {
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "'Lexend', sans-serif" }}>
      ...
      {/* ══════════ SECTION 1 — HERO ══════════ */}
      <SectionShell section={heroSec} className="relative flex items-center px-6" defaultBg={{ minHeight: "100vh", background: "linear-gradient(180deg, #0D0D1A 0%, #111122 100%)", paddingTop: 40, paddingBottom: 40 }}>
